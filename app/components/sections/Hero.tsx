        ...
        >
          ...
          <div className="relative inline-block">
            <motion.h1
              ...
              className="text-hero text-text-primary mb-4 tracking-tight cursor-pointer select-none relative z-10 hover:text-accent-orange transition-colors duration-300"
